...
<body>
    <div class="d-flex">
        {{-- SIDEBAR --}}
        <nav id="sidebar" class="sidebar d-flex flex-column p-0 d-none d-md-flex" style="width:240px; min-width:240px;">
        ...
        {{-- MOBILE SIDEBAR --}}
        <nav id="mobile-sidebar" class="sidebar d-flex flex-column p-0 position-fixed top-0 start-0 h-100 d-md-none" style="width:240px; z-index: 1050; transform: translateX(-100%); transition: transform 0.3s ease;">
